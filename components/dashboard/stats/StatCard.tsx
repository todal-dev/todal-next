...
export function StatCard({ title, value, subtitle, icon: Icon, iconColor, iconBgColor, trend }: StatCardProps) {
  return (
    <motion.div
      ...
      className="bg-warm-white dark:bg-dark-ocean-card rounded-lg border border-gray-200 dark:border-gray-600 p-4 sm:p-6 hover:shadow-lg hover:border-gray-300 dark:hover:border-gray-500 dark:hover:shadow-gray-900/50 transition-all touch-manipulation cursor-pointer"
    >
      <div className="flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          <p className="text-body-small font-medium text-gray-600 dark:text-gray-400 mb-2">{title}</p>
        ...
        <div className={`rounded-full p-3 sm:p-3.5 flex-shrink-0 ${iconBgColor} transition-transform hover:scale-110`}>
