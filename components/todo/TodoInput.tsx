    ...
    <div style={{ paddingLeft: `${level * 24}px` }}>
      ...
      {!hideButton && (
        <motion.button
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-gray-400 dark:text-gray-500 hover:text-primary dark:hover:text-primary-100 w-full text-left min-h-[44px] cursor-pointer"
        >
          <Plus size={14} />
